        ...
        return (
            <section className="page__section page__section_b">
                ...
                <div className="element description">
                    ...
                    <p>Если вас 2 -3 человека предлагаю поехать на экскурсию в Гуамý на современном автомобиле. Цена &mdash; 180 евро (180 за всех кто в машине)</p>
                    <p>Если хотите поехать на ретроавтомобиль, то в салон помещается 4 человека, не считая водителя и меня.</p>
                    <p>Цена &mdash; 180 евро за машину. И неважно сколько человек в машине, один или 4, цена 180. В автомобиле есть кондиционер.</p>
                    <p>Если вас больше чем 4 человека, то предлагаю минивэн на 9 мест. Цена &mdash; 260 евро за всю машину, соответственно.</p>
