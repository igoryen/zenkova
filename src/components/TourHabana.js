        ...
        return (
            <section className="page__section page__section_a">
                ...
                <div className="element description">
                    ...
                    <p>Если вас 2-3 человека предлагаю поехать на экскурсию в Гавану на современном автомобиле. Цена 160 евро (160 за всех кто в машине).</p>
                    <p>Если хотите поехать на Ретро автомобиле, то в салон помещается 4 человека, не считая водителя и меня.</p>
                    <p>Цена тоже 160 евро за машину. И не важно сколько человек в машине, один или 4, цена 160.</p>
                    ...
                    <p>После обеда - осмотр достопримечательностей современной Гаваны: Капитолия, Президентского дворца, Площади Революции, центральных улиц и знаменитой набережной города - Малекон.</p>
