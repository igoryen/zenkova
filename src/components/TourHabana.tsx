        ...
        return (
            <section className="page__section page__section_a">
                ...
                <div className="element description">
                    <h2>Дневная экскурсия</h2>

                    <p>Если вас 2-3 человека предлагаю поехать на экскурсию в Гавану на современном автомобиле. Цена &mdash; 160 евро (160 за всех кто в машине).</p>
                    <p>Если хотите поехать на Ретро автомобиле, то в салон помещается 4 человека, не считая водителя и меня.</p>
                    <p>Цена &mdash; тоже 160 евро за машину. И не важно сколько человек в машине, один или 4, цена 160.</p>
                    <p>В автомобиле есть кондиционер.</p>
                    <p>Если вас больше чем 4 человека, то предлагаю минивэн на 9 мест. Цена 250 евро за всю машину, соответственно.</p>
                    ...
                    <p>Вы посетите колониальные части Гаваны: здания, площади, крепости, возведённые испанцами в XVI-XIX веках (пешая прогулка).</p>
                    ...
                    <p>После обеда &mdash; осмотр достопримечательностей современной Гаваны: Капитолия, Президентского дворца, Площади Революции, центральных улиц и знаменитой набережной города &mdash; Малекон.</p>
